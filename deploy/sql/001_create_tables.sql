...
CREATE TABLE dbo.users (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_users_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_users_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.staff_users (
    ...
    last_login_at DATETIME2(3) NULL,
    deleted_at DATETIME2(3) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_staff_users_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_staff_users_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.auth_refresh_tokens (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_auth_refresh_tokens_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.product_categories (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_product_categories_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_product_categories_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME())
);
...
CREATE TABLE dbo.materials (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_materials_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_materials_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.products (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_products_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_products_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.product_images (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_product_images_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.product_skus (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_product_skus_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_product_skus_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.printers (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_printers_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_printers_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.model_files (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_model_files_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    deleted_at DATETIME2(3) NULL,
...
CREATE TABLE dbo.custom_requests (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_custom_requests_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_custom_requests_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.custom_request_reviews (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_custom_request_reviews_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.orders (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_orders_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_orders_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.quotes (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_quotes_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_quotes_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.print_tasks (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_print_tasks_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_print_tasks_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.production_schedule_orders (
    ...
    created_by BIGINT NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_production_schedule_orders_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_production_schedule_orders_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.production_schedule_items (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_production_schedule_items_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_production_schedule_items_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.printer_status_logs (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_printer_status_logs_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.finished_goods_inventory (
    ...
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_finished_goods_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.warehouses (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouses_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouses_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.warehouse_locations (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_locations_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_locations_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.warehouse_stock_items (
    ...
    created_by BIGINT NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_stock_items_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_stock_items_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    row_version ROWVERSION NOT NULL,
...
CREATE TABLE dbo.warehouse_inbound_records (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_inbound_records_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.shipments (
    ...
    remark NVARCHAR(1000) NULL,
    created_by BIGINT NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_shipments_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_shipments_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.shipment_packages (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_shipment_packages_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_shipment_packages_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.shipment_items (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_shipment_items_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.warehouse_outbound_records (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_outbound_records_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
    updated_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_outbound_records_updated_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.warehouse_outbound_items (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_warehouse_outbound_items_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.inventory_locks (
    ...
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_inventory_locks_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.material_stock_logs (
    ...
    remark NVARCHAR(1000) NULL,
    created_by BIGINT NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_material_stock_logs_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.idempotency_keys (
    ...
    expires_at DATETIME2(3) NOT NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_idempotency_keys_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
...
CREATE TABLE dbo.operation_logs (
    ...
    remark NVARCHAR(1000) NULL,
    created_at DATETIME2(3) NOT NULL CONSTRAINT DF_operation_logs_created_at DEFAULT DATEADD(HOUR, 8, SYSUTCDATETIME()),
